...
```
  ...
  -h, --help                              help for apply
      ...
      --local-reg-service NamespaceName   NamespaceName of the local registry service deployed on the cluster. For example: registry-name/registry-namespace (default "default/source-registry")
